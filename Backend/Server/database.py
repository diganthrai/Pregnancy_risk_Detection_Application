...
with open('Backend/ML/Random_Forest/model.pkl', 'rb') as f:
    model = pickle.load(f)

#Add new user
def create_user(name, email,trimester, age, systolic_bp, diastolic_bp, bs, body_temp, heart_rate):
...
#Add the readingd
def add_health_params(user_id, systolic_bp, diastolic_bp, bs, body_temp, heart_rate):
...
def prediction(latest_health_params):
    if latest_health_params:
        ...
        BS = latest_health_params['blood_sugar']
        ...
        print(Age, SystolicBP, DiastolicBP, BS, BodyTemp, HeartRate)
...
if __name__ == '__main__':
    ...
    # create_user(name, email, trimester, age, systolic_bp, diastolic_bp, bs, body_temp, heart_rate)
    add_health_params(user_id, systolic_bp, diastolic_bp, bs, body_temp, heart_rate)
